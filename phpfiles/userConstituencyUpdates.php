...
if($min <=0)
$min=0;
$result=mysql_query("select C.name,U.msg,U.msg_id,U.date_time,C.pic from CAND_SIGNUP as C,CAND_UPDATES as U where C.constituency_id=$user_const_id and C.cand_id=U.cand_id") or die(mysql_error());

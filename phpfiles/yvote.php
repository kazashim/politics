...
if($min <=0)
$min=0;
$result=mysql_query("select V.username,date_time,reason,anonymous,pic from VOTE_UP_DOWN as V,USER_SIGNUP as U where V.vote=1 and U.user_id=V.user_id and V.cand_id= $cand_id  order by date_time desc") or die(mysql_error());
